<!-- шаблон страницы (входа) кабинета пользователя -->
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		@include('personal.includes.sidebar') <!-- вставка из resources\views\resonal\includes\sidebar.blade.php -->

		@yield('content') <!-- расширение из resources\views\resonal\main\index.blade.php -->
