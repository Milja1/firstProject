...
<div class="content-wrapper">
  	...
  	<section class="content">
		...
		<div class="row">
			...
			<a href="{{ route('admin.category.create') }}" class="btn btn-block btn-info">{{ __('Добавить') }}</a>
			</div>
		</div>
					...
					<div class="card-body table-responsive p-0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('admin.category.show', $category->id) }}" class="btn btn-block btn-outline-primary btn-sm">
										<i class="far fa-eye"></i>
										{{ __('Просмотр') }}
								</td>									
								<td>                     
									<a href="{{ route('admin.category.edit', $category->id) }}" class="btn btn-block btn-outline-success btn-sm w-60">
