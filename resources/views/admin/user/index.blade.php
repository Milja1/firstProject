					...
					<div class="card-body table-responsive p-0">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $user->name }}</td>
								<td>
									<a href="{{ route('admin.user.show', $user->id) }}" class="btn btn-block btn-outline-primary btn-sm">
										<i class="far fa-eye"></i>
										{{ __('Просмотр') }}
								</td>									
								<td>                     
									<a href="{{ route('admin.user.edit', $user->id) }}" class="btn btn-block btn-outline-success btn-sm w-60">
