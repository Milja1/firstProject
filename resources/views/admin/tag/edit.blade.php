<!-- расширение 'Редактирование ТЕГА' в шаблон страницы (входа) административной панели resources\views\admin\layouts\main.blade.php -->
              ...
              <div class="col-12">
				  ...
				  @method('PATCH') <!-- т.к. метод передачи запроса не GET и не POST -->
                    <div class="form-group">
                        <input type="text" class="form-control" name="title" placeholder="{{ __('Введите название тега') }}" value="{{ $tag->title }}">
